...
class TestRealDPM86XX(TestCase):
    ...
    def test_set_voltage(self):
        ...
        self.dpm.write_output_status(0)  # Ensure output is off before setting voltages
    ...
    def test_set_current(self):
        ...
        self.dpm.write_output_status(0)  # Start with the output disabled
    ...
    def test_set_voltage_and_current(self):
        ...
        self.dpm.write_output_status(0)  # Disable output before setting
    ...
    def test_read_actual_current(self):
        ...
        print(f'Current: {self.dpm.read_actual_current_in_milliamperes()}mA')
        self.dpm.write_output_status(0)  # Disable output after reading
